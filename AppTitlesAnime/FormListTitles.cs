...
namespace AppTitlesAnime
{
    public partial class FormListTitles : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            this.dataGridViewTitles.DataSource = this.db.AnimeTitles.Include(i => i.Type).Select(i => new
            {
                i.Id,
                i.Type.TypeName,
                i.OriginalName,
        ...
        {
            FormAddTitle formAddTitle = new FormAddTitle();
            List<Type> types = this.db.Types.Local.OrderBy(o => o.TypeName).ToList();
            formAddTitle.comboBoxType.DataSource = types;
            formAddTitle.comboBoxType.DisplayMember = "type_name";
            DialogResult result = formAddTitle.ShowDialog();
            ...
            {
                OriginalName = formAddTitle.textBoxOriginalName.Text,
                Name = formAddTitle.textBoxAnimeName.Text,
                CountSeries = Convert.ToInt16(formAddTitle.numUpDownCountSeries.Value),
                Duration = Convert.ToInt16(formAddTitle.numUpDownDuration.Value),
                Studio = formAddTitle.textBoxStudio.Text,
                Description = formAddTitle.textBoxDescription.Text
            };
        }
    }
}
